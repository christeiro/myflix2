...
describe Category do
  ...
  it { should validate_presenct_of(:name) }
  describe "#recent_videos" do
    it "returns the videos in the reverse chronical order by created at" do
      comedies = Category.create(name: "comedies")
      futurama = Video.create(title: "Futurama", description: "Futurama Description", created_at: 1.day.ago, category: comedies)
      south_park = Video.create(title: "South Park", description: "South Park", category: comedies)
